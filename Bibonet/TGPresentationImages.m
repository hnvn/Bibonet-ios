...
/////// MY MODIFICATION: ADD CART ICON ////////
- (UIImage *) tabBarCartIcon
{
    return [self imageWithKey:@"tabCart" generator:^UIImage *{
        return [TGPresentationAssets tabBarCartIcon:self.pallete.tabIconColor];
    }];
}
