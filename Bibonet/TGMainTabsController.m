...
//////// MY MODIFICATION: REPALCE CONTACTS BY SHOPPING ////////
//@property (nonatomic, strong) TGTabBarButton *contactsButton;
@property (nonatomic, strong) TGTabBarButton *shoppingButton;
...
//        _contactsButton = [[TGTabBarButton alloc] initWithImage:presentation.images.tabBarContactsIcon title:TGLocalized(@"Contacts.TabTitle") presentation:presentation];
        _shoppingButton = [[TGTabBarButton alloc] initWithImage:presentation.images.tabBarCartIcon title:TGLocalized(@"Shopping.TabTitle") presentation:presentation];
...
//        [_tabButtons addObject:_contactsButton];
        [_tabButtons addObject:_shoppingButton];
...
//    [_contactsButton setImage:presentation.images.tabBarContactsIcon presentation:presentation];
    [_shoppingButton setImage:presentation.images.tabBarCartIcon presentation:presentation];
